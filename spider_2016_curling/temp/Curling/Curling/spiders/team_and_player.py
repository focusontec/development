...
class TeamAndPlayerSpider(scrapy.Spider):
    ...
    def parse_event(self,response):
        ...
        team_n_type_selector = response.xpath('//div[@class="textblock5 textblockBODY tbnormal"]|'
                                              '//div[@class="textblock1 textblockBODY tbnormal"]'
                                              '|//div[@class="textblock1"]|//div[@class="textblock0"]')
        if len(team_n_type_selector) == 0:
            ...
            for item in team_n_type_selector:
                if item.xpath('./@class').extract_first() == "textblock5 textblockBODY tbnormal" or "textblock0":
